...
import com.example.mymoviedb.viewModel.SavedViewModel
...
class SavedFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.savedMovie.observe(viewLifecycleOwner, Observer { it->
            it?.let {
                this.findNavController().navigate(HomeFragmentDirections.actionHomeFragmentToSavedMovieDetailFragment(it.movieId))
