...
import com.example.mymoviedb.ui.saved.detailMovie.DetailMovieFragmentArgs
import com.example.mymoviedb.ui.saved.detailMovie.DetailMovieFragmentDirections
        ...
        viewModel.navigateToDetailPeople.observe(viewLifecycleOwner, Observer { it ->
            it?.let{
                this.findNavController().navigate(
                    DetailMovieFragmentDirections.actionDetailMovieFragmentToDetailPeopleFragment(
                        it.id
                    )
                )
